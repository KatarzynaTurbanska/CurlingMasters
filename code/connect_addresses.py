...
def connect_addresses():
    facility = pd.read_csv('../data/backup/addresses_facilities.csv')
    people = pd.read_csv('../data/backup/addresses_people.csv')
    match = pd.read_csv('../data/backup/match_opponents_v2.csv')
    ...
    data2.to_csv('../data/backup/match_opponents_v3.csv')
